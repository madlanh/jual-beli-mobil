                ...
                <form method="POST" action="{{ route('customers.update', $customer->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="address" id="address" 
                                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>{{ old('address', $customer->address) }}</textarea>
                    </div>
